...
/** 
 * DAO for table "WECHAT".
*/
public class WechatDao extends AbstractDao<Wechat, Long> {

    public static final String TABLENAME = "WECHAT";

    /**
     * Properties of entity Wechat.<br/>
    ...
    public WechatDao(DaoConfig config) {
        super(config);
    }
    
    public WechatDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WECHAT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WECHAT\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Wechat entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Wechat entity) {
        stmt.clearBindings();
    ...
    @Override
    public Wechat readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Wechat entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Wechat entity, long rowId) {
        entity.setLid(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Wechat entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(Wechat entity) {
